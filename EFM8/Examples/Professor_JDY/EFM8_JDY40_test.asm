...
;	EFM8_JDY40_test.c:253: SendATCommand("AT+RFIDFFBB\r\n");
	...
	mov	b,#0x80
	lcall	_SendATCommand
;	EFM8_JDY40_test.c:256: SendATCommand("AT+VER\r\n");
	mov	dptr,#__str_5
	mov	b,#0x80
	lcall	_SendATCommand
;	EFM8_JDY40_test.c:257: SendATCommand("AT+BAUD\r\n");
	mov	dptr,#__str_6
	mov	b,#0x80
	lcall	_SendATCommand
;	EFM8_JDY40_test.c:258: SendATCommand("AT+RFID\r\n");
	mov	dptr,#__str_7
	mov	b,#0x80
	lcall	_SendATCommand
;	EFM8_JDY40_test.c:259: SendATCommand("AT+DVID\r\n");
	mov	dptr,#__str_8
	mov	b,#0x80
	lcall	_SendATCommand
;	EFM8_JDY40_test.c:260: SendATCommand("AT+RFC\r\n");
	mov	dptr,#__str_9
	mov	b,#0x80
	lcall	_SendATCommand
;	EFM8_JDY40_test.c:261: SendATCommand("AT+POWE\r\n");
	mov	dptr,#__str_10
	mov	b,#0x80
	lcall	_SendATCommand
;	EFM8_JDY40_test.c:262: SendATCommand("AT+CLSS\r\n");
	mov	dptr,#__str_11
	mov	b,#0x80
	lcall	_SendATCommand
;	EFM8_JDY40_test.c:264: printf("\r\Press and hold the BOOT button to transmit.\r\n");
	mov	a,#__str_12
	push	acc
	mov	a,#(__str_12 >> 8)
	push	acc
...
L014014?:
	...
	add	a,#0xf8
	mov	sp,a
;	EFM8_JDY40_test.c:272: sendstr1(buff);
	mov	dptr,#_buff
	mov	b,#0x40
	lcall	_sendstr1
